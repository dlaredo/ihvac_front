...
angular
  ...
  .config(['$stateProvider', '$urlRouterProvider',
    function ($stateProvider, $urlRouterProvider) {
      ...
      .state('app.hello', {
        url: '/hello',
        templateUrl: 'views/common/tessst.html',
        resolve: {
          deps: ['$ocLazyLoad', function ($ocLazyLoad) {
            return $ocLazyLoad.load([
              {
              ...
              return $ocLazyLoad.load('scripts/controllers/helloo.js');
            });
                    }]
        },
        data: {
...
/*
      ...
      .state('app.pie', {
        url: '/piet',
        templateUrl: 'views/pieview.html',
        resolve: {
          deps: ['$ocLazyLoad', function ($ocLazyLoad) {
            return $ocLazyLoad.load([
              {
              ...
              return $ocLazyLoad.load('scripts/controllers/pietest.js');
            });
                    }]
        },
        data: {
